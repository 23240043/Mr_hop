...
CREATE TABLE `ambiente` (
  ...
  `imagen` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'default.jpg',
  `orden` int DEFAULT '0',
...
CREATE TABLE `categorias` (
  ...
  `tipo` enum('bebida','comida','combo') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `mesas` (
  ...
  `qr_codigo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado` enum('libre','ocupada','reservada') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'libre',
  PRIMARY KEY (`id`),
...
CREATE TABLE `pedidos` (
  ...
  `tipo` enum('mesa','domicilio') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'mesa',
  `direccion_entrega` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado` enum('pendiente','en_preparacion','emplatado','listo','entregado','cancelado') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pendiente',
...
-- Dump completed on 2026-05-19  1:21:36
